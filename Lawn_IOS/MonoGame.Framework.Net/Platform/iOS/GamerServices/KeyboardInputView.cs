	...
	class KeyboardInputView : UIScrollView {
			...
			: base(frame)
		{
			...
			var toolbarItems = new UIBarButtonItem[] {
				...
				new UIBarButtonItem (UIBarButtonSystemItem.FlexibleSpace, null as UIAction),
			...
			_description.TextColor = UIColor.DarkText.ColorWithAlpha (0.95f);
