                        ...
                        if (lp != null)
                        {
                            ...
                            else
                            {
                                ...
                                lp.AuthenticateHandler = delegate(UIViewController controller, NSError error)
                                {
                                    ...
                                    if (controller != null)
                                        ((UIViewController)Main.Instance.Services.GetService(typeof(UIViewController))).PresentViewController(controller, true, null);
                                };
                            }
                        }
                    });
