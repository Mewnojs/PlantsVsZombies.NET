...
namespace Sexy
{
    public /*internal*/ class Constants : FrameworkConstants
    {
        ...
        public static void Load600x1000()
        {
            ...
            Constants.MAIN_MENU_ORIGIN_X = 800;
            Constants.ACHIEVEMENTS_ORIGIN_X = 800;
            Constants.QUICKPLAY_ORIGIN_X = 1800;
            Constants.MORE_GAMES_PLANK_HEIGHT = 125;
            Constants.MORE_GAMES_PLANK_WIDTH = 400;
            Constants.MORE_GAMES_ITEM_GAP = 3;
            Constants.SMALL_SEEDPACKET_WIDTH = 101;
            Constants.SMALL_SEEDPACKET_HEIGHT = 65;
            Constants.SEED_CHOOSER_OFFSETSCREEN_OFFSET = 600;
            Constants.SCROLL_AREA_OFFSET_X = 128;
            Constants.SCROLL_AREA_OFFSET_Y = (int)Constants.InvertAndScale(28f);
            Constants.DIALOG_HEADER_OFFSET = 45;
            Constants.WIDE_BOARD_WIDTH = 900;
            Constants.ImageWidth = (int)(Constants.S * 1400f);
            Constants.LAWN_XMIN = 140;
            Constants.LAWN_YMIN = 80;
            Constants.SEED_PACKET_HORIZ_GAP = (int)Constants.InvertAndScale(2f);
            Constants.SEED_PACKET_VERT_GAP = (int)Constants.InvertAndScale(1f);
            Constants.SeedPacket_Selector_Pos = new Point(-6, 3);
            Constants.TitleScreen_ReanimStart_X = 163;
            Constants.GameSelector_Width = 2935;
            Constants.GameSelector_Height = (int)Constants.InvertAndScale(640f);
            Constants.GameSelector_AdventureButton_X = 538;
            Constants.GameSelector_MiniGameButton_X = Constants.GameSelector_AdventureButton_X + 26;
            Constants.GameSelector_MiniGameButton_Y = (int)Constants.InvertAndScale(100f);
            Constants.GameSelector_OptionsButton_X = 828;
            Constants.GameSelector_OptionsButton_Y = 345;
            Constants.GameSelector_ZenGardenButton_X = 523;
            Constants.GameSelector_ZenGardenButton_Y = 436;
            Constants.GameSelector_AlmanacButton_X = 670;
            Constants.GameSelector_AlmanacButton_Y = 418;
            Constants.GameSelector_StoreButton_X = 469;
            Constants.GameSelector_StoreButton_Y = 341;
            Constants.GameSelector_LeaderboardButton_X = 0;
            Constants.GameSelector_LeaderboardButton_Y = (int)Constants.InvertAndScale(200f);
            Constants.GameSelector_AchievementsButton_X = 264;
            Constants.GameSelector_AchievementsButton_Y = 536;
            Constants.GameSelector_AchievementsStatue_X = 265;
            Constants.GameSelector_AchievementsStatue_Y = 315;
            Constants.GameSelector_MoreWaysToPlay_MiniGames_X = 295;
            Constants.GameSelector_MoreWaysToPlay_MiniGames_Y = (int)Constants.InvertAndScale(160f);
            Constants.GameSelector_MoreWaysToPlay_VaseBreaker_X = 656;
            Constants.GameSelector_MoreWaysToPlay_VaseBreaker_Y = (int)Constants.InvertAndScale(175f);
            Constants.GameSelector_MoreWaysToPlay_IZombie_X = 438;
            Constants.GameSelector_MoreWaysToPlay_IZombie_Y = (int)Constants.InvertAndScale(195f);
            Constants.GameSelector_MoreWaysToPlay_Back_X = 413;
            Constants.GameSelector_MoreWaysToPlay_Back_Y = (int)Constants.InvertAndScale(270f);
            Constants.GameSelector_PlayerName_Pos = new Point(209, -238);
            Constants.GameSelector_LevelNumber_1_Pos = new Point(691, 40);
            Constants.GameSelector_LevelNumber_2_Pos = new Point(725, 41);
            Constants.GameSelector_LevelNumber_3_Pos = new Point(740, 43);
            Constants.GameSelector_LevelNumber_Bar = new Rectangle(716, 55, 6, 3);
            Constants.GameSelector_LevelNumber_ButtonDown_Offset = 8;
            Constants.GameSelector_Update_Offset = 110;
            Constants.LeaderboardScreen_Vasebreaker_Button_X = 791;
            Constants.LeaderboardScreen_Vasebreaker_Button_Y = 424;
            Constants.LeaderboardScreen_IZombie_Button_X = 156;
            Constants.LeaderboardScreen_IZombie_Button_Y = 383;
            Constants.LeaderboardScreen_Killed_Button_X = 506;
            Constants.LeaderboardScreen_Killed_Button_Y = 383;
            Constants.LeaderboardScreen_PileBase_X = 414;
            Constants.LeaderboardScreen_PileBase_Y = 66;
            Constants.Leaderboard_IZombie_Score_X = 248;
            Constants.Leaderboard_IZombie_Score_Y = 363;
            Constants.Leaderboard_Vasebreaker_Score_X = 873;
            Constants.Leaderboard_Vasebreaker_Score_Y = 403;
            Constants.Leaderboard_Pile_1_X = 371;
            Constants.LeaderboardDialog_CannotConnect_Rect = new TRect(38, 88, 713, 375);
            Constants.LeaderboardScreen_EdgeOfSpace_Overlay_Offset = 38;
            Constants.AchievementWidget_ROW_HEIGHT = 169;
            Constants.AchievementWidget_ROW_START = 344;
            Constants.AchievementWidget_HOLE_DEPTH = 160;
            Constants.AchievementWidget_GAMERSCORE_POS = new Point(271, 431);
            Constants.AchievementWidget_BackButton_X = 190;
            Constants.AchievementWidget_BackButton_Y = 8;
            Constants.AchievementWidget_BackButton_Rect = new TRect(190, 0, 213, 150);
            Constants.AchievementWidget_Background_Offset_Y = 515;
            Constants.AchievementWidget_Description_Box = new Rectangle(338, 38, 500, 88);
            Constants.AchievementWidget_Pipe_Offset = new Point(0, 175);
            Constants.AchievementWidget_Worm_Offset = new Point(824, -130);
            Constants.AchievementWidget_ZombieWorm_Offset = new Point(95, -11);
            Constants.AchievementWidget_GemLeft_Offset = new Point(225, 0);
            Constants.AchievementWidget_GemRight_Offset = new Point(563, -86);
            Constants.AchievementWidget_Fossile_Offset = new Point(299, -69);
            Constants.AchievementWidget_Image_Pos = new Point(250, 13);
            Constants.AchievementWidget_Image_Size = 80;
            Constants.AchievementWidget_Name_Pos = new Point(338, 0);
            Constants.AchievementWidget_Name_MaxWidth = 500;
            Constants.QuickPlayWidget_Thumb_X = 25;
            Constants.QuickPlayWidget_Thumb_Y = 19;
            Constants.QuickPlayWidget_Bungee_Y = -65;
            Constants.SeedChooserScreen_MenuButton_X = 831;
            Constants.SeedChooserScreen_Background_Top = new Point(110, 5);
            Constants.SeedChooserScreen_Background_Middle = new Point(Constants.SeedChooserScreen_Background_Top.X, Constants.SeedChooserScreen_Background_Top.Y + 55);
            Constants.SeedChooserScreen_Background_Middle_Height = 406;
            Constants.SeedChooserScreen_Background_Bottom = new Point(Constants.SeedChooserScreen_Background_Top.X, Constants.SeedChooserScreen_Background_Middle.Y + Constants.SeedChooserScreen_Background_Middle_Height);
            ...
            Constants.SeedPacket_CostText_IZombie_Pos = new Point(91, 29);
            Constants.ImitaterDialog_Size = new Point(0, 300);
            Constants.ImitaterDialog_ScrollWidget_Offset_X = 6;
            Constants.ImitaterDialog_ScrollWidget_Y = 150;
            Constants.ImitaterDialog_ScrollWidget_ExtraWidth = 25;
            Constants.ImitaterDialog_Height = 313;
            Constants.ImitaterDialog_BottomGradient_Y = 294;
            Constants.CutScene_ReadySetPlant_Pos = new Point(463, 325);
            Constants.CutScene_LogoEndPos = 438;
            Constants.CutScene_LogoBackRect_Height = 150;
            Constants.CutScene_LogoEnd_Particle_Pos = new Point(750, 500);
            Constants.CutScene_ExtraRoom_1_Particle_Pos = new Point(35, 348);
            Constants.CutScene_ExtraRoom_2_Particle_Pos = new Point(Constants.CutScene_ExtraRoom_1_Particle_Pos.X, 246);
            Constants.CutScene_ExtraRoom_3_Particle_Pos = new Point(Constants.CutScene_ExtraRoom_1_Particle_Pos.X, 459);
            Constants.CutScene_ExtraRoom_4_Particle_Pos = new Point(32, 150);
            ...
            Constants.CutScene_SodRoll_3_Pos = new Point(-6, -205);
            Constants.CutScene_SodRoll_4_Pos = new Point(-6, 205);
            Constants.CutScene_Upsell_TerraCotta_Arrow = new Point(916, 450);
            Constants.CutScene_Upsell_TerraCotta_Pot = new Point(706, 450);
            Constants.ConveyorBeltClipRect = new TRect(0, 10, 104, 581);
            Constants.StoreScreen_BackButton_X = 538;
            Constants.StoreScreen_BackButton_Y = 488;
            Constants.StoreScreen_Car_X = 325;
            Constants.StoreScreen_Car_Y = 100;
            Constants.StoreScreen_PrevButton_X = 396;
            Constants.StoreScreen_PrevButton_Y = 370;
            Constants.StoreScreen_NextButton_X = 806;
            Constants.StoreScreen_NextButton_Y = 370;
            Constants.StoreScreen_HatchOpen_X = 395;
            Constants.StoreScreen_HatchOpen_Y = -44;
            Constants.StoreScreen_HatchClosed_X = 386;
            Constants.StoreScreen_HatchClosed_Y = 101;
            Constants.StoreScreen_CarNight_X = 325;
            Constants.StoreScreen_CarNight_Y = 100;
            Constants.StoreScreen_StoreSign_X = 563;
            Constants.StoreScreen_StoreSign_Y_Min = -188;
            Constants.StoreScreen_StoreSign_Y_Max = -13;
            Constants.StoreScreen_Coinbank_X = 738;
            Constants.StoreScreen_Coinbank_Y = 506;
            Constants.StoreScreen_Coinbank_TextOffset = new Point(225, 10);
            Constants.StoreScreen_ItemOffset_1_X = 538;
            Constants.StoreScreen_ItemOffset_1_Y = 128;
            Constants.StoreScreen_ItemOffset_2_X = 610;
            Constants.StoreScreen_ItemOffset_2_Y = 238;
            Constants.StoreScreen_ItemSize = 106;
            Constants.StoreScreen_ItemSize_Offset = 5;
            Constants.StoreScreen_PriceTag_X = 4;
            Constants.StoreScreen_PriceTag_Y = 88;
            Constants.StoreScreen_PriceTag_Text_Offset_X = 44;
            Constants.StoreScreen_PriceTag_Text_Offset_Y = 84;
            Constants.StoreScreen_ComingSoon_X = 125;
            Constants.StoreScreen_ComingSoon_Y = 88;
            Constants.StoreScreen_SoldOut_Width = 100;
            Constants.StoreScreen_SoldOut_Y = 0;
            Constants.StoreScreen_SoldOut_Height = 125;
            Constants.StoreScreen_PacketUpgrade_X = 13;
            Constants.StoreScreen_PacketUpgrade_Y = 6;
            Constants.StoreScreen_PacketUpgrade_Text_Size = new Rectangle(0, 0, 100, 75);
            Constants.StoreScreen_RetardedDave_Offset_X = -13;
            Constants.StoreScreen_FirstAidNut_Offset_Y = 13;
            Constants.StoreScreen_PoolCleaner_Offset_X = 29;
            Constants.StoreScreen_PoolCleaner_Offset_Y = 30;
            Constants.StoreScreen_Rake_Offset_X = -13;
            Constants.StoreScreen_Rake_Offset_Y = 30;
            Constants.StoreScreen_RoofCleaner_Offset_X = 19;
            Constants.StoreScreen_RoofCleaner_Offset_Y = 48;
            Constants.StoreScreen_Imitater_Offset_X = -1;
            Constants.StoreScreen_Imitater_Offset_Y = 30;
            Constants.StoreScreen_Default_Offset_Y = 25;
            Constants.StoreScreen_MouseRegion = new Point(94, 125);
            Constants.StoreScreen_Dialog = new Rectangle(250, 63, 500, 563);
            Constants.StoreScreen_PotPlant_Offset = new Point(50, 88);
            Constants.StoreScreenMushroomGardenOffsetX = 19;
            Constants.StoreScreenAquariumGardenOffsetX = 19;
            Constants.StoreScreenGloveOffsetY = 19;
            Constants.StoreScreenWheelbarrowOffsetY = 19;
            Constants.StoreScreenBugSprayOffsetX = 21;
            Constants.StoreScreenBugSprayOffsetY = 19;
            Constants.StoreScreenPhonographOffsetY = 19;
            Constants.StoreScreenPlantFoodOffsetX = 16;
            Constants.StoreScreenPlantFoodOffsetY = 19;
            Constants.StoreScreenWateringCanOffsetX = 8;
            Constants.StoreScreenWateringCanOffsetY = 19;
            Constants.NewOptionsDialog_FXLabel_X = 425;
            Constants.NewOptionsDialog_FXLabel_Y = 179;
            Constants.NewOptionsDialog_MusicLabel_X = 425;
            Constants.NewOptionsDialog_MusicLabel_On_Y = 121;
            Constants.NewOptionsDialog_MusicLabel_Off_Y = 129;
            Constants.NewOptionsDialog_VibrationLabel_X = 425;
            Constants.NewOptionsDialog_VibrationLabel_Y = 241;
            Constants.NewOptionsDialog_LockedLabel_Y = 331;
            Constants.NewOptionsDialog_VibrationLabel_MaxWidth = 375;
            Constants.NewOptionsDialog_FullScreenOffset = 31;
            Constants.NewOptionsDialog_FX_Offset = 19;
            Constants.NewOptionsDialog_Music_Offset = 6;
            Constants.NewOptionsDialog_Version_Low_Y = 425;
            Constants.NewOptionsDialog_Version_High_Y = 431;
            Constants.RetardedDave_Bubble_Tip_Offset = 6;
            Constants.RetardedDave_Bubble_Offset_Shop = new Point(-350, -146);
            Constants.RetardedDave_Bubble_Offset_Board = new Point(-250, -75);
            Constants.RetardedDave_Bubble_Size = 500;
            Constants.RetardedDave_Bubble_Rect = new TRect(19, 8, 0, 313);
            Constants.RetardedDave_Bubble_TapToContinue_Y = 288;
            Constants.PlantGallerySize = new Point(488, 938);
            Constants.ZombieGallerySize = new Point(519, 1335);
            Constants.AlmanacHeaderY = 10;
            Constants.Almanac_PlantsButtonRect = new TRect(84, 188, 375, 300);
            Constants.Almanac_ZombiesButtonRect = new TRect(563, 188, 375, 300);
            Constants.Almanac_CloseButtonRect = new TRect(825, 544, 185, 49);
            Constants.Almanac_IndexButtonRect = new TRect(553, 544, 185, 49);
            Constants.Almanac_IndexPlantPos = new Point(229, 300);
            Constants.Almanac_IndexZombiePos = new Point(691, 281);
            Constants.Almanac_IndexPlantTextPos = new Point(Constants.Almanac_PlantsButtonRect.mX + Constants.Almanac_PlantsButtonRect.mWidth / 2, Constants.Almanac_PlantsButtonRect.mY + Constants.Almanac_PlantsButtonRect.mHeight - 81);
            Constants.Almanac_IndexZombieTextPos = new Point(Constants.Almanac_ZombiesButtonRect.mX + Constants.Almanac_ZombiesButtonRect.mWidth / 2, Constants.Almanac_ZombiesButtonRect.mY + Constants.Almanac_ZombiesButtonRect.mHeight - 81);
            Constants.Almanac_PlantScrollRect = new TRect(59, 94, 475, 460);
            Constants.Almanac_ZombieScrollRect = new TRect(35, 94, 513, 460);
            Constants.Almanac_DescriptionScrollRect = new TRect(588, 319, 381, 209);
            Constants.Almanac_PlantTopGradientY = 93;
            Constants.Almanac_ZombieTopGradientY = 90;
            Constants.Almanac_BottomGradientY = 540;
            Constants.Almanac_PlantGradientWidth = 450;
            Constants.Almanac_ZombieGradientWidth = 488;
            Constants.Almanac_ZombieStoneRect = new TRect(556, 3, 441, 581);
            Constants.Almanac_BackgroundPosition = new Point(666, 75);
            Constants.Almanac_ZombieClipRect = new TRect(-50, -56, 219, 219);
            Constants.Almanac_NavyRect = new TRect(644, 50, 245, 248);
            Constants.Almanac_NamePosition = new Point(778, 0);
            Constants.Almanac_ClayRect = new TRect(563, 8, 425, 581);
            Constants.Almanac_BrownRect = new TRect(641, 51, 248, 248);
            Constants.Almanac_ZombieSpace = new Point(171, 146);
            Constants.Almanac_ZombieOffset = new Point(0, 6);
            Constants.Almanac_BossPosition = new Point(256, 1180);
            Constants.Almanac_ImpPosition = new Point(85, 1180);
            Constants.Almanac_ImitatorPosition = new Point(Constants.PlantGallerySize.X / 2 - 65, 860);
            Constants.Almanac_SeedSpace = new Point(5, 5);
            Constants.Almanac_SeedOffset = new Point(20, 10);
            Constants.Almanac_ZombiePosition = new Point(700, 120);
            Constants.Almanac_PlantPosition = new Point(729, 131);
            Constants.Almanac_Text_Scale = 0.8f;
            Constants.Almanac_PlantsHeader_Pos = new Point(40, 3);
            Constants.Almanac_ZombieHeader_Pos = new Point(31, 3);
            Constants.Almanac_ItemName_MaxWidth = 413;
            Constants.Zombie_StartOffset = 110f;
            Constants.Zombie_StartRandom_Offset = 40f;
            Constants.AwardScreen_Note_Credits_Background = new Rectangle(-625, -213, 2000, 1000);
            ...
            Constants.UILevelPosition = new Point(991, 556);
            Constants.UIMenuButtonPosition = new Point(813 - Constants.Board_Offset_AspectRatio_Correction, 4);
            Constants.UIMenuButtonWidth = 188;
            Constants.UISunBankPositionX = 119;
            Constants.UISunBankTextOffset = new Point(115, 4);
            Constants.UIShovelButtonPosition = new Point(325, 4);
            Constants.UIProgressMeterPosition = new Point(463, 4);
            Constants.UIProgressMeterHeadEnd = 275;
            Constants.UIProgressMeterBarEnd = 281;
