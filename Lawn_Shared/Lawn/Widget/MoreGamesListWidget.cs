...
namespace Lawn
{
    public/*internal*/ class MoreGamesListWidget : Widget
    {
        ...
        public void AddRow(Image image, Rect theSrcRect, string link)
        {
        ...
        public override void Draw(Graphics g)
        {
            for (int i = 0; i < mGames.Count; i++)
            {
                ...
                int num = mGames[i].mY;
                LawnCommon.DrawImageBox(g, new Rect(7, num, Constants.MORE_GAMES_PLANK_WIDTH, Constants.MORE_GAMES_PLANK_HEIGHT), AtlasResources.IMAGE_REANIM_SELECTORSCREEN_MOREGAMES_PLANK);
