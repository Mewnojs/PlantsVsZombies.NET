...
namespace Sexy
{
    internal class Constants : FrameworkConstants
    {
        public static void Load320x480()
        {
            ...
            Constants.LeaderboardDialog_CannotConnect_Rect = new Rect(100, 100, 300, 300);
            ...
            Constants.AchievementWidget_BackButton_Rect = new Rect(54, 0, 105, 80);
            ...
            Constants.ConveyorBeltClipRect = new Rect(0, 5, 54, 310);
            ...
            Constants.RetardedDave_Bubble_Rect = new Rect(8, 6, 0, 144);
            ...
            Constants.Almanac_PlantsButtonRect = new Rect(40, 100, 180, 160);
            Constants.Almanac_ZombiesButtonRect = new Rect(260, 100, 180, 160);
            Constants.Almanac_CloseButtonRect = new Rect(396, 290, 89, 26);
            Constants.Almanac_IndexButtonRect = new Rect(265, 290, 89, 26);
            ...
            Constants.Almanac_PlantScrollRect = new Rect(28, 50, 237, 245);
            Constants.Almanac_ZombieScrollRect = new Rect(17, 50, 250, 245);
            Constants.Almanac_DescriptionScrollRect = new Rect(282, 170, 183, 111);
            ...
            Constants.Almanac_ZombieStoneRect = new Rect(267, 1, 212, 310);
            Constants.Almanac_BackgroundPosition = new Point(320, 40);
            Constants.Almanac_ZombieClipRect = new Rect(-22, -30, 109, 109);
            Constants.Almanac_NavyRect = new Rect(306, 27, 134, 134);
            Constants.Almanac_NamePosition = new Point(373, 0);
            Constants.Almanac_ClayRect = new Rect(270, 4, 204, 310);
            Constants.Almanac_BrownRect = new Rect(306, 27, 133, 133);
            ...
            Constants.AwardScreen_ClayTablet = new Rect(31, 54, 418, 190);
            Constants.AwardScreen_TitlePos = new Point(240, 13);
            Constants.AwardScreen_GroundDay_Pos = new Point(70, 112);
            Constants.AwardScreen_BrownRect = new Rect(56, 97, 133, 133);
            Constants.AwardScreen_BottomMessage_Pos = new Point(240, 56);
            Constants.AwardScreen_BottomText_Rect_Text = new Rect(208, 114, 218, 100);
            Constants.AwardScreen_BottomText_Rect_NoText = new Rect(131, 78, 218, 140);
            Constants.AwardScreen_CreditsButton = new Rect(50, 278, 140, 32);
            ...
            Constants.ConfirmPurchaseDialog_Background = new Rect(26, 70, 262, 140);
            Constants.ConfirmPurchaseDialog_Item_Pos = new Point(42, 80);
            Constants.ConfirmPurchaseDialog_Text = new Rect(120, 70, 150, 140);
            ...
            Constants.LastStandButtonRect = new Rect(200, 297, 140, 28);
            ...
            Constants.Challenge_SlotMachineHandle_Pos = new Rect(473, 0, 55, 80);
        ...
        public static void Load480x800()
        {
            ...
            Constants.Leaderboard_Vasebreaker_Score_Y = 322;
            Constants.Leaderboard_Pile_1_X = 297;
            Constants.LeaderboardDialog_CannotConnect_Rect = new Rect(30, 70, 570, 300);
            Constants.LeaderboardScreen_EdgeOfSpace_Overlay_Offset = 30;
            ...
            Constants.AchievementWidget_BackButton_Rect = new Rect(152, 0, 170, 120);
            ...
            Constants.CutScene_Upsell_TerraCotta_Pot = new Point(565, 360);
            Constants.ConveyorBeltClipRect = new Rect(0, 8, 83, 465);
            ...
            Constants.RetardedDave_Bubble_Rect = new Rect(15, 6, 0, 250);
            ...
            Constants.Almanac_PlantsButtonRect = new Rect(67, 150, 300, 240);
            Constants.Almanac_ZombiesButtonRect = new Rect(450, 150, 300, 240);
            Constants.Almanac_CloseButtonRect = new Rect(660, 435, 148, 39);
            Constants.Almanac_IndexButtonRect = new Rect(442, 435, 148, 39);
            ...
            Constants.Almanac_PlantScrollRect = new Rect(47, 75, 380, 368);
            Constants.Almanac_ZombieScrollRect = new Rect(28, 75, 410, 368);
            Constants.Almanac_DescriptionScrollRect = new Rect(470, 255, 305, 167);
            ...
            Constants.Almanac_ZombieStoneRect = new Rect(445, 2, 353, 465);
            Constants.Almanac_BackgroundPosition = new Point(533, 60);
            Constants.Almanac_ZombieClipRect = new Rect(-40, -45, 175, 175);
            Constants.Almanac_NavyRect = new Rect(515, 40, 196, 198);
            Constants.Almanac_NamePosition = new Point(622, 0);
            Constants.Almanac_ClayRect = new Rect(450, 6, 340, 465);
            Constants.Almanac_BrownRect = new Rect(513, 41, 198, 198);
            ...
            Constants.AwardScreen_ClayTablet = new Rect(50, 70, 700, 300);
            Constants.AwardScreen_TitlePos = new Point(400, 10);
            Constants.AwardScreen_GroundDay_Pos = new Point(111, 167);
            Constants.AwardScreen_BrownRect = new Rect(90, 145, 200, 200);
            Constants.AwardScreen_BottomMessage_Pos = new Point(400, 70);
            Constants.AwardScreen_BottomText_Rect_Text = new Rect(317, 160, 400, 170);
            Constants.AwardScreen_BottomText_Rect_NoText = new Rect(150, 120, 500, 200);
            Constants.AwardScreen_CreditsButton = new Rect(180, 413, 140, 48);
            ...
            Constants.ConfirmPurchaseDialog_Background = new Rect(38, 100, 312, 250);
            Constants.ConfirmPurchaseDialog_Item_Pos = new Point(60, 155);
            Constants.ConfirmPurchaseDialog_Text = new Rect(145, 95, 190, 265);
            ...
            Constants.LastStandButtonRect = new Rect(240, 439, 210, 46);
            ...
            Constants.Challenge_SlotMachineHandle_Pos = new Rect(672, 425, 100, 80);
        ...
        public static Rect LeaderboardDialog_CannotConnect_Rect;
        ...
        public static Rect AchievementWidget_BackButton_Rect;
        ...
        public static Rect ConveyorBeltClipRect;
        ...
        public static Rect RetardedDave_Bubble_Rect;

        public static int RetardedDave_Bubble_TapToContinue_Y;

        public static int AlmanacHeaderY;

        public static Rect Almanac_PlantsButtonRect;

        public static Rect Almanac_ZombiesButtonRect;

        public static Rect Almanac_CloseButtonRect;

        public static Rect Almanac_IndexButtonRect;
        ...
        public static Rect Almanac_PlantScrollRect;

        public static Rect Almanac_ZombieScrollRect;

        public static Rect Almanac_DescriptionScrollRect;
        ...
        public static Rect Almanac_ZombieStoneRect;

        public static Point Almanac_BackgroundPosition;

        public static Rect Almanac_ZombieClipRect;

        public static Rect Almanac_NavyRect;

        public static Point Almanac_NamePosition;

        public static Rect Almanac_ClayRect;

        public static Rect Almanac_BrownRect;
        ...
        public static Rect AwardScreen_ClayTablet;

        public static Point AwardScreen_TitlePos;

        public static Point AwardScreen_GroundDay_Pos;

        public static Rect AwardScreen_BrownRect;

        public static Point AwardScreen_BottomMessage_Pos;

        public static Rect AwardScreen_BottomText_Rect_Text;

        public static Rect AwardScreen_BottomText_Rect_NoText;

        public static Rect AwardScreen_CreditsButton;
        ...
        public static Rect ConfirmPurchaseDialog_Background;

        public static Point ConfirmPurchaseDialog_Item_Pos;

        public static Rect ConfirmPurchaseDialog_Text;
        ...
        public static Rect LastStandButtonRect;
        ...
        public static Rect Challenge_SlotMachineHandle_Pos;
