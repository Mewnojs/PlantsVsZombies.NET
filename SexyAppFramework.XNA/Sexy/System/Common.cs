...
namespace Sexy
{
    ...
    public/*internal*/ static class Common
    {
        ...
        {
            return SexyGlobal.CommaSeperate_(theValue);
        }
        ...
        {
            string applicationStoragePath = SexyGlobal.gSexyAppBase.applicationStoragePath;
