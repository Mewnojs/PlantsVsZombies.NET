...
namespace Sexy
{
    public/*internal*/ class AchievementItem
    {
        ...
        public AchievementItem(Achievement a)
        {
            ...
            {
                AchievementImage = new Image(Texture2D.FromStream(SexyGlobal.g.GraphicsDevice, picture));
            }
        }
    ...
    public/*internal*/ static class Achievements
    {
        static Achievements()
        {
