...
namespace Sexy
{
    ...
    public/*internal*/ static class ReportAchievement
    {
        ...
        public static void GivePendingAchievements()
        {
            ...
            {
                SexyGlobal.gSexyAppBase.ShowAchievementMessage(ReportAchievement.pendingAchievementAlerts.Dequeue());
            }
        }
