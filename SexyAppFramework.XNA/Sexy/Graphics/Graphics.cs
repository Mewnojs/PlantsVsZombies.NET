...
namespace Sexy
{
    ...
    public/*internal*/ class Graphics : GraphicsState, IReusable
    {
        ...
        public void BeginFrame(RasterizerState rasterState, SpriteSortMode sortmode)
        {
            ...
            //
            var matrix = SexyGlobal.gSexyAppBase.mScreenScales.ScaleMatrix * SexyGlobal.gSexyAppBase.mScreenScales.TranslationMatrix;
            //
        ...
        public void ClearClipRect()
        {
            ...
            else
            {
                ...
                //aClipRect = new TRect(0, 0, SexyGlobal.gSexyAppBase.mWidth, SexyGlobal.gSexyAppBase.mHeight);
            }
            mClipRect = aClipRect;
        }
        ...
        public/*internal*/ void Translate(int x, int y)
        {
            mTransX += x;
            mTransY += y;
        }
        ...
        {
            SexyGlobal.g.pushTransform(ref theTransform, concatenate);
        }
        ...
        {
            SexyGlobal.g.clearTransformStack();
        }
        ...
        public void HardwareClip(SpriteSortMode spriteSortMode)
        {
            ...
            if (!mIsOffscreen) // if the graphics isn't on screen, the transformation won't apply
                SexyGlobal.gSexyAppBase.mScreenScales.Scale(ref aRect);
            ...
            if (!mIsOffscreen)	// see above
                SexyGlobal.gSexyAppBase.mScreenScales.Scale(ref bRect);
        ...
        public void HardwareClipRect(TRect theClip, SpriteSortMode sortMode)
        {
            ...
            theClip.mX += mTransX;
            theClip.mY += mTransY;
            SexyGlobal.gSexyAppBase.mScreenScales.Scale(ref theClip);
