...
namespace Sexy
{
    public/*internal*/ static class LeaderBoardComm
    {
        ...
        public static void RecordResult(LeaderboardGameMode gameMode, int score)
        {
            ...
            SignedInGamer gamer = IMain.GetGamer();
            lock (LeaderBoardComm.LeaderboardLock)
            {
                ...
                {
                    SexyGlobal.gSexyAppBase.ShowUpdateRequiredMessage();
                }
                catch (Exception)
                {
                }
            ...
            lock (LeaderBoardComm.LeaderboardLock)
            {
                try
                {
                    ...
                    if (gamer != null)
                    {
                        ...
                        //Texture2D theTexture = Texture2D.FromStream(SexyGlobal.g.GraphicsDevice, gamerProfile.GetGamerPicture());
    ...
    public/*internal*/ enum LeaderboardState
    {
        Adventure,
        IZombie,
        Vasebreaker
