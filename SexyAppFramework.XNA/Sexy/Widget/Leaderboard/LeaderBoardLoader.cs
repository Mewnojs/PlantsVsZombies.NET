    ...
    internal class LeaderBoardLoader
    {
        ...
        public void LoadEntry(int index)
        {
            if (index < reader.PageStart)
            {
                ...
                {
                    pagingUp = true;
                    reader.BeginPageUp(new AsyncCallback(PageUpRequestReceived), IMain.GetGamer());
                    return;
                }
            }
            ...
            {
                pagingDown = true;
                reader.BeginPageDown(new AsyncCallback(PageDownRequestReceived), IMain.GetGamer());
            }
        }
