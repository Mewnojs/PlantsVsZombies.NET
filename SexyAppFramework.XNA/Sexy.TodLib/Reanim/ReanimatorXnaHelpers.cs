...
{
    public/*internal*/ class ReanimatorXnaHelpers
    {
        ...
        {
            if (!SexyGlobal.gSexyAppBase.mResourceManager.LoadReanimation(theFilename, ref theDefinition))
            {
                return false;
            }
        ...
        public static void ReanimatorEnsureDefinitionLoaded(ReanimationType theReanimType, bool theIsPreloading)
        {
            ...
            if (theIsPreloading && SexyGlobal.gSexyAppBase.mShutdown)
            {
                return;
            }
