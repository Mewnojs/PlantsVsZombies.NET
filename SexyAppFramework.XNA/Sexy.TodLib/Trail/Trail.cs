    ...
    public/*internal*/ class Trail
    {
        ...
        public void Draw(Graphics g)
        {
            ...
            for (int i = 0; i < mNumTrailPoints - 1; i++)
            {
                ...
                array2[0].x = (mTrailCenter.x + trailPoint.aPos.x + sexyVector2.x * num3 * num5) * FrameworkConstants.S;
                array2[0].y = (mTrailCenter.y + trailPoint.aPos.y + sexyVector2.y * num3 * num5) * FrameworkConstants.S;
                array2[1].x = (mTrailCenter.x + trailPoint.aPos.x + -sexyVector2.x * num3 * num5) * FrameworkConstants.S;
                array2[1].y = (mTrailCenter.y + trailPoint.aPos.y + -sexyVector2.y * num3 * num5) * FrameworkConstants.S;
                array2[2].x = (mTrailCenter.x + trailPoint2.aPos.x + sexyVector3.x * num4 * num6) * FrameworkConstants.S;
                array2[2].y = (mTrailCenter.y + trailPoint2.aPos.y + sexyVector3.y * num4 * num6) * FrameworkConstants.S;
                array2[3].x = (mTrailCenter.x + trailPoint2.aPos.x + -sexyVector3.x * num4 * num6) * FrameworkConstants.S;
                array2[3].y = (mTrailCenter.y + trailPoint2.aPos.y + -sexyVector3.y * num4 * num6) * FrameworkConstants.S;
                int num11 = i * 2;
