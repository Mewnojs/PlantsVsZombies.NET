...
namespace Sexy.TodLib
{
    public/*internal*/ static class TodCommon
    {
        ...
        {
            int num2 = (int)(num * FrameworkConstants.S + 0.5f);
            return num2 * FrameworkConstants.IS;
        }
        ...
        {
            string text = TodStringFile.TodStringTranslate(theText);
            return text.Replace(theStringToFind, SexyAppBase.ToString(theNumber));
        }
        ...
        {
            TodResourceManager todResourceManager = (TodResourceManager)SexyGlobal.gSexyAppBase.mResourceManager;
        ...
        public static bool TodLoadResources(string theGroup)
        {
            ...
            Resources.ExtractResourcesByName(SexyGlobal.gSexyAppBase.mResourceManager, theGroup);
        ...
        {
            ResourceManager resourceManager = SexyGlobal.gSexyAppBase.mResourceManager;
