...
{
    public/*internal*/ static class TodParticleGlobal
    {
        public static void TodParticleLoadDefinitions(ref ParticleParams[] theParticleParamArray, int theParticleParamArraySize)
        {
            ...
            for (int j = 0; j < TodParticleGlobal.gParticleParamArraySize; j++)
            {
                ...
                SexyGlobal.gSexyAppBase.mNumLoadingThreadTasks += 6;
            }
        }
        ...
        {
            if (!SexyGlobal.gSexyAppBase.mResourceManager.LoadParticle(aFilename, ref theParticleDef))
            {
                return false;
            }
